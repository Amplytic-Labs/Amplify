...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('amplify_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('amplify_profile', JSON.stringify(profileStore.get()));
  }
};
