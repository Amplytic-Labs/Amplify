      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-amplify-elements-textPrimary dark:text-amplify-elements-textPrimary-dark'
              : 'text-amplify-elements-textSecondary dark:text-amplify-elements-textSecondary-dark hover:text-amplify-elements-textPrimary dark:hover:text-amplify-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-amplify-elements-textTertiary dark:text-amplify-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
