      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-amplify-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-amplify-elements-item-backgroundAccent hover:bg-amplify-elements-artifacts-backgroundHover"
