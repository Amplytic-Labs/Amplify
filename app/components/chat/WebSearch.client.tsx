...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-amplify-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-amplify-elements-borderColor bg-amplify-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-amplify-elements-background-depth-1 text-amplify-elements-textPrimary',
              'placeholder-amplify-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-amplify-elements-button-primary-background text-amplify-elements-button-primary-text',
