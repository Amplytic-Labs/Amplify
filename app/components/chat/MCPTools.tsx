  ...
  return (
    <div className="relative">
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            <div className="i-svg-spinners:90-ring-with-bg text-amplify-elements-loader-progress text-xl animate-spin"></div>
          ) : (
            <div className="i-amplify:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-amplify-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-amplify-elements-icon-error">{error}</p>}</div>
              </div>
