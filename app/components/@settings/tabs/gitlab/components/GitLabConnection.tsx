...
export default function GitLabConnection({ connectionTest, onTestConnection }: GitLabConnectionProps) {
  ...
  return (
    <motion.div
      className="bg-amplify-elements-background border border-amplify-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-medium text-amplify-elements-textPrimary">GitLab Connection</h3>
          </div>
        </div>

        {!isConnected && (
          <div className="text-xs text-amplify-elements-textSecondary bg-amplify-elements-background-depth-1 p-3 rounded-lg mb-4">
        ...
        <form onSubmit={handleConnect}>
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block text-sm text-amplify-elements-textSecondary mb-2">GitLab URL</label>
              <input
                type="text"
                value={gitlabUrl}
