        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-amplify-elements-textSecondary">Configure and manage your local AI models</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-amplify-elements-textSecondary">Enable All</span>
              <Switch
          ...
          {filteredProviders.map((provider) => (
            <div key={provider.name} className="space-y-4">
              ...
              {provider.name === 'Ollama' && provider.settings.enabled && (
                <Card className="mt-4 bg-amplify-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        className="bg-transparent hover:bg-amplify-elements-background-depth-2"
                      >
                        {isLoadingModels ? (
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-semibold text-amplify-elements-textPrimary">Available Models</h3>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                    ...
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="grid gap-4">
                        {lmStudioModels.map((model) => (
                          <Card key={model.id} className="bg-amplify-elements-background-depth-3">
                            <CardContent className="p-4">
                              <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                  <h4 className="text-sm font-medium text-amplify-elements-textPrimary font-mono">
                                    {model.id}
                                  </h4>
