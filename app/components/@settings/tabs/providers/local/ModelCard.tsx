...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="bg-amplify-elements-background-depth-3 hover:bg-amplify-elements-background-depth-4 transition-all duration-200 shadow-sm hover:shadow-md border border-amplify-elements-borderColor hover:border-blue-500/20">
