  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-amplify-elements-background border border-amplify-elements-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-amplify-elements-textPrimary">Connect to GitHub</h2>
                <button
                  onClick={handleClose}
                  className="p-1 rounded-md hover:bg-amplify-elements-item-backgroundActive/10"
                >
                  <div className="i-ph:x w-4 h-4 text-amplify-elements-textSecondary" />
                </button>
              </div>

              <div className="text-xs text-amplify-elements-textSecondary bg-amplify-elements-background-depth-1 p-3 rounded-lg">
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-amplify-elements-textSecondary mb-2">Token Type</label>
                  <select
                    value={tokenType}
                    ...
                    className={classNames(
                      ...
                      'focus:outline-none focus:ring-1 focus:ring-amplify-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                ...
                <div>
                  <label className="block text-sm text-amplify-elements-textSecondary mb-2">
