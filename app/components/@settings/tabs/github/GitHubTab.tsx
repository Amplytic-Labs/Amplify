    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-amplify-elements-textPrimary">GitHub Integration</h2>
        </div>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {connection?.rateLimit && (
              <div className="flex items-center gap-2 px-3 py-1 bg-amplify-elements-background-depth-1 rounded-lg text-xs">
                <div className="i-ph:cloud w-4 h-4 text-amplify-elements-textSecondary" />
                <span className="text-amplify-elements-textSecondary">
        ...
        {stats?.repos && stats.repos.length > 0 && (
          <motion.div
            ...
            className="border-t border-amplify-elements-borderColor pt-6"
          >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-amplify-elements-background dark:bg-amplify-elements-background-depth-2 border border-amplify-elements-borderColor dark:border-amplify-elements-borderColor hover:border-amplify-elements-borderColorActive/70 dark:hover:border-amplify-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-amplify-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-amplify-elements-textSecondary hover:text-amplify-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-amplify-elements-borderColor">
