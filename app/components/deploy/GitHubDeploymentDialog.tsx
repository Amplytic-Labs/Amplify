              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-amplify-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-amplify-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-amplify-elements-background-depth-2 dark:bg-amplify-elements-background-depth-3 border border-amplify-elements-borderColor dark:border-amplify-elements-borderColor-dark text-amplify-elements-textPrimary dark:text-amplify-elements-textPrimary-dark placeholder-amplify-elements-textTertiary dark:placeholder-amplify-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                        maxLength={100}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-amplify-elements-textPrimary dark:text-amplify-elements-textPrimary-dark group-hover:text-blue-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-amplify-elements-background-depth-2 dark:bg-amplify-elements-background-depth-3 rounded-lg border border-amplify-elements-borderColor dark:border-amplify-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-amplify-elements-borderColor dark:border-amplify-elements-borderColor-dark text-blue-500 focus:ring-blue-500 dark:bg-amplify-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
