...
Welcome! This guide provides all the details you need to contribute effectively to the project. Thank you for helping us make **Amplify** a better tool for developers worldwide. 💡
...
- Clone the repository:
  ```bash
  git clone https://github.com/amplify/Amplify.git
  ```
...
```bash
docker run -p 5173:5173 --env-file .env.local amplify-ai:development
```
...
```bash
docker build . --target amplify-ai-production
```
