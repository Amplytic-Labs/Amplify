...
echo "Starting Amplify update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/amplify/amplify/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
